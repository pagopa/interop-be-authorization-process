...
class ApiInvoker(formats: Formats)(implicit system: ActorSystem) extends CustomContentTypes with Json4sSupport {
  import it.pagopa.pdnd.interop.uservice.authorizationprocess.client.invoker.ApiInvoker._
  import it.pagopa.pdnd.interop.uservice.authorizationprocess.client.invoker.ParametersMap._
